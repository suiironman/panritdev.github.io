...
function About() {
  return (
    <div>
      <h1
        id="about"
        className="flex py-10 justify-center font-medium lg:text-5xl md:text-xl sm:text-base"
      >
        About me
      </h1>
      <div className="flex gap-20">
        <div className="card w-3/6 h-96 items-center justify-center bg-base-100 shadow-xl">
          <h2 className="card-title text-3xl font-bold py-5">
            Hi there! I'm a dedicated web developer passionate about crafting
            engaging online experiences.
          </h2>
          <p>
            With expertise in HTML, CSS (utilizing frameworks like TailwindCSS,
            DaisyUI, Flowbite), and JavaScript (especially ReactJS), I thrive on
            bringing ideas to life in the digital world. My journey in web
            development has equipped me with hands-on experience in building
            user-friendly interfaces and scalable solutions. Whether it's
            creating dynamic web applications or fine-tuning the user
            experience, I'm committed to delivering high-quality, efficient
            code.
          </p>
        </div>

        <div className="card w-3/6 h-96 items-center justify-center bg-base-100">
          <ul className="timeline timeline-vertical lg:timeline-horizontal">
            ...
            <li>
              <hr />
              <div className="timeline-start timeline-box flex justify-between">
                <div className="flex items-center mr-5">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-20 w-10 mr-2"
                    viewBox="0 0 48 48"
                  >
                    <path
                      fill="#00acc1"
